...
class Xicro{
    ...
    private:
        ...
        void _SendDouble(double *data,uint8_t len);
        void _SendString(std::string *data,uint8_t len);
        ...
        // gen
        void* _nonverify[1][16][9];
        void* _verify[1][16][9];
        uint8_t _Idtopic_sub[1]={1};
        uint8_t _TopicType[1][16]={{132,32,242,222,222,222,222,223,222,222,222,223,222,222,222,223}};
        uint8_t _Totalvar[1]={16};
        uint8_t _Nofdata[1][16]={{1, 1, 1, 1, 1, 1, 1, 9, 1, 1, 1, 9, 1, 1, 1, 9}};
